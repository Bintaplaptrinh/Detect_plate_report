...
import cv2
import Preprocess
from knn_model import load_knn, predict_char
...
# IMG_W = 1920 #follow by image what test
# IMG_H = 1080 #follow by image what test


img = cv2.imread(img_path)
img_w, img_h, _ = img.shape
img = cv2.resize(img, dsize=(img_h, img_w))

kNearest = load_knn("knn_model.xml")
...
if detected == 1:
    ...
    for screenCnt in screenCnt:
        ...
        for i in char_x:
            ...
            strCurrentChar = predict_char(kNearest, npaROIResized, k=3)  # ASCII of characters
